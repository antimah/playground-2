...
@section('content')
    <section class="px-6 py-8">
        <main class="max-w-lg mx-auto mt-10">
            ...
            <form method="POST" action="/register" class="mt-10 bg-gray-100 p-6 rounded-xl border border-gray-200">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input class="border border-gray-400 p-2 w-full" type="text" value="{{ old('name') }}" name="name" id="name" required>
                    @error('name')
